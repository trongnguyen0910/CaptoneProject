...
class _CompleteProfileState extends State<CompleteProfile> {
  ...
  _register() async {
    ...
    var request = http.Request(
      'POST',
      Uri.parse('http://fruitseasonapi-001-site1.atempurl.com/api/farmers'),
    );
                    ...
                    child: Align(
                      child: image != null
                          ...
                          : SizedBox(
                              ...
                              height: 128 * fem,
                              child: Image.asset(
                                'assets/mobile/images/profile.png',
                                fit: BoxFit.cover,
                              ),
                            ),
                    ),
                    ...
                    child: Align(
                      child: GestureDetector(
                        ...
                        child: SizedBox(
                          ...
                          height: 18 * fem,
                          child: Image.asset(
                            'assets/mobile/images/edit-image.png',
                            fit: BoxFit.cover,
                          ),
                        ),
                      ),
